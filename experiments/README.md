...
- Model capacity studies
- Training and validation behavior
- Optimization methods
- Model-to-model comparisons
- Error analysis
- Performance and computational comparisons

The goal is to keep the learning notebooks readable while using this folder for more complete experimental analysis.

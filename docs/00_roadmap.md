...
- [x] Core mathematics and ML foundations
...
- [x] Learning notebook
- [x] Documentation
- [x] Clean source implementation

## Softmax Regression

- [x] NumPy implementation on MNIST
- [x] Numerical gradient checking
- [x] Learning-rate experiments
- [x] Batch-size experiments
...
- [x] Width experiment
- [x] Depth experiment
- [x] Softmax vs MLP comparison
- [x] Documentation
- [x] Clean source implementation

## CNN

- [ ] Learn CNN foundations
- [ ] Build baseline CNN
- [ ] Evaluate model
- [ ] Extract clean source implementation
- [ ] Write documentation
- [ ] Run structured experiments
- [ ] Compare with MLP
...
- [x] Define purpose of `experiments/`
- [ ] Softmax systematic experiments
- [ ] MLP systematic experiments
- [ ] CNN systematic experiments
- [ ] ViT systematic experiments
